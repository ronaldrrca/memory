...
//Agregando los elementos div "back", cara postrior
...
container.appendChild(div1_f); container.appendChild(div1_b); container.appendChild(div2_f); container.appendChild(div2_b);
container.appendChild(div3_f); container.appendChild(div3_b); container.appendChild(div4_f); container.appendChild(div4_b);
container.appendChild(div5_f); container.appendChild(div5_b); container.appendChild(div6_f); container.appendChild(div6_b); 
container.appendChild(div7_f); container.appendChild(div7_b); container.appendChild(div8_f); container.appendChild(div8_b);
container.appendChild(div9_f); container.appendChild(div9_b); container.appendChild(div10_f); container.appendChild(div10_b); 
container.appendChild(div11_f); container.appendChild(div11_b); container.appendChild(div12_f); container.appendChild(div12_b);
container.appendChild(div13_f); container.appendChild(div13_b); container.appendChild(div14_f); container.appendChild(div14_b); 
container.appendChild(div15_f); container.appendChild(div15_b); container.appendChild(div16_f); container.appendChild(div16_b);
container.appendChild(div17_f); container.appendChild(div17_b); container.appendChild(div18_f); container.appendChild(div18_b);
container.appendChild(div19_f); container.appendChild(div19_b); container.appendChild(div20_f); container.appendChild(div20_b);
container.appendChild(div21_f); container.appendChild(div21_b); container.appendChild(div22_f);  container.appendChild(div22_b); 
container.appendChild(div23_f); container.appendChild(div23_b); container.appendChild(div24_f); container.appendChild(div24_b);
container.appendChild(div25_f); container.appendChild(div25_b); container.appendChild(div26_f); container.appendChild(div26_b); 
container.appendChild(div27_f); container.appendChild(div27_b); container.appendChild(div28_f); container.appendChild(div28_b);
container.appendChild(div29_f); container.appendChild(div29_b); container.appendChild(div30_f); container.appendChild(div30_b); 
container.appendChild(div31_f); container.appendChild(div31_b); container.appendChild(div32_f); container.appendChild(div32_b);
container.appendChild(div33_f); container.appendChild(div33_b); container.appendChild(div34_f); container.appendChild(div34_b);
container.appendChild(div35_f); container.appendChild(div35_b); container.appendChild(div36_f); container.appendChild(div36_b);
